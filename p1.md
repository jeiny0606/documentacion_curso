...
quiz: '{"question":"¿Cuál es el atajo de teclado comúnmente ut4ilizado para abrir el panel de búsqueda global (Search) en Visual Studio Code?","options":["a) Ctrl + F","b) Alt + S","c) Ctrl + P","d) Shift + F"],"answer":"c) Ctrl + P"}'
---
